...
pub mod questions {
    pub fn question_1() -> char {
        /// Which of the following statements about rent fees on Solana is true?
        ///
        /// a) Rent fee is charged every slot unless the account has a sufficient balance to cover 2 years' worth of rent.
        /// b) Rent fee is charged every epoch unless the account has a sufficient balance to cover 2 years' worth of rent.
        /// c) Smaller accounts pay rent twice per epoch.
        /// d) Account size does not affect the rent fee.
        'b'
    }
